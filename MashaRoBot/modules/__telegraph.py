    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("Uploaded to telegraph \nhttps://telegra.ph{}".format(media_urls[0]), link_preview=True)
        elif input_str == "xt":
            ...
            ms = (end - start).seconds
            await event.reply("Pasted to telegraph \nhttps://telegra.ph/{} in {} seconds.".format(response["path"], ms), link_preview=True)
    else:
